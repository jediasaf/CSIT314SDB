    ...
    function display(){
      ...
      if($_SERVER['REQUEST_METHOD'] === 'GET'){
        ...
        if($_POST['submit'] == "Edit"){
          ...
          $message = $message.'<meta http-equiv="refresh" content="5; url='.'ManagerPage.php'.'" />';
        }
        else if($_POST['submit'] == "Delete"){
          $username = $_POST['username'];
          
          $result = $controller->run("deleteManager",$username);
          if($result){
            $message = '<meta http-equiv="refresh" content="5; url='.'ManagerPage.php'.'" />';
            $message = '<div style="border-radius:200px; height:200px; width:200px; background: #F8FAF5; margin:0 auto;">
                    <i class="checkmark">✓</i>
...
$display = new EditManagerProfile();
$display->display();
?>