...
--
-- Host: 127.0.0.1:3307
-- Generation Time: May 19, 2023 at 10:47 AM
...
INSERT INTO `bookingdb` (`bookingID`, `phoneNo`, `username`, `bookingDate`, `movieID`, `noOfTickets`, `seats`, `adultTicket`, `seniorTicket`, `studentTicket`, `childTicket`, `foodNo`, `totalPrice`, `isClaimed`, `claimUsername`) VALUES
(1, 88999886, 'acalafato1x', '2022-12-31', 'AWhiskerAway2020', 2, 'J1, J2', 0, 1, 0, 1, 2, 28, 0, ''),
(2, 99814416, 'cwiggington2d', '2022-11-30', 'TheBossBaby2017', 3, 'A5, A6, A7', 1, 1, 0, 1, 1, 32, 0, ''),
(3, 87002613, 'btuer2n', '2023-03-25', 'Slumberland2022', 2, 'C3, C4', 1, 0, 1, 0, 1, 28, 1, 'cdickie2j'),
(4, 85560197, 'lraynes27', '2023-03-14', 'WeHaveaGhost2023', 5, 'C1, C2, C3, C4, C5', 2, 1, 1, 1, 5, 84, 1, 'cdickie2j'),
(5, 88884822, 'ghewsi', '2023-04-09', 'AWhiskerAway2020', 7, 'B2, B3, B4, B5, B6, B7, B8', 3, 2, 1, 1, 4, 94, 1, 'ctwist2a'),
(6, 85279247, 'sbrockbank2c', '2023-05-14', 'Fireworks2017', 9, 'A1, A2, A3, A4, A5, A6, A7, A8, A9', 1, 2, 3, 3, 7, 122, 0, ''),
(7, 81344165, 'dmutimer1n', '2023-01-14', 'Fireworks2017', 10, 'D1, D2, D3, D4, D5, E1, E2, E3, E4, E5', 10, 0, 0, 0, 11, 208, 1, 'gacosta1y'),
...
(10, 92056088, 'mreicharzq', '2023-02-22', 'Don\'tWorryDarling2022', 3, 'J5, J6, J7', 1, 1, 0, 1, 3, 48, 1, 'cflewittg'),
...
(13, 89477929, 'msearsh', '2023-03-19', 'Fireworks2017', 6, 'F1, F2, F3, F4, F5, F6', 2, 1, 1, 2, 6, 98, 1, 'ctenant1e'),
(14, 87338947, 'wworge1g', '2023-06-12', 'TheDeparted2006', 8, 'G1, G2, G3, G4, G5,  J1, J2, J3', 5, 2, 1, 0, 5, 120, 0, ''),
(15, 99684759, 'roliff1c', '2023-01-24', 'TheDeparted2006', 1, 'A1', 0, 0, 1, 0, 0, 8, 1, 'ctenant1e'),
(16, 99060729, 'rmaccaghan29', '2023-05-09', 'Slumberland2022', 2, 'D7, E8', 0, 2, 0, 0, 0, 12, 1, 'neasseby2m'),
(17, 97933407, 'lvargat', '2023-01-20', 'WeHaveaGhost2023', 4, 'A7, A8, A9, A10', 1, 0, 2, 1, 2, 50, 1, 'bmuston15'),
(18, 92405327, 'jstuckow7', '2023-03-24', 'RideOn2023', 1, 'B4', 0, 1, 0, 0, 1, 14, 0, ''),
(19, 91852754, 'cmelato28', '2023-01-08', 'WeHaveaGhost2023', 5, 'E5, E6, E7, E8, E10', 2, 1, 0, 2, 8, 106, 1, 'gacosta1y'),
...
CREATE TABLE `customerdb` (
  ...
  `genrePref` varchar(15) DEFAULT NULL,
  `loyaltyPts` int(7) DEFAULT NULL,
...
CREATE TABLE `fooddb` (
  ...
  `foodPicName` varchar(50) DEFAULT NULL,
...
CREATE TABLE `moviedb` (
  ...
  `actor_1_name` varchar(30) DEFAULT NULL,
  `actor_2_name` varchar(30) DEFAULT NULL,
  `actor_3_name` varchar(30) DEFAULT NULL,
  `country` varchar(50) DEFAULT NULL,
  `classificationRating` varchar(5) DEFAULT NULL,
  `yearReleased` date DEFAULT NULL,
  `rantings` decimal(2,1) DEFAULT NULL,
  `trailerLink` varchar(100) DEFAULT NULL,
  `moviePicName` varchar(50) DEFAULT NULL,
...
('AWhiskerAway2020', 'A Whisker Away', 'Fantasy', 'Junichi Sato', 'Miyo Sasaki is in love with her classmate Kento Hinode and tries repeatedly to get Kento\'s attention by transforming into a cat, but at some point, the boundary between herself and the cat becomes ambiguous.', 104, 'Mirai Shida', 'Natsuki Hanae', 'Hiroaki Ogi', 'Japan', 'PG', '0000-00-00', 6.7, 'https://www.youtube.com/watch?v=aXc9DVfLTGo', 'AWhiskerAway2020.png', 0),
('Air2023', 'Air', 'Drama', 'Ben Affleck', 'Follows the history of shoe salesman Sonny Vaccaro, and how he led Nike in its pursuit of the greatest athlete in the history of basketball, Michael Jordan.', 112, 'Matt Damon', 'Jason Bateman', 'Ben Affleck', 'USA', 'NC-16', '0000-00-00', 7.8, 'https://www.youtube.com/watch?v=Euy4Yu6B3nU', 'Air2023.png', 0),
('Belle2021', 'Belle', 'Animation', 'Mamoru Hosoda', 'Suzu is a shy high school student living in a rural village. For years, she has only been a shadow of herself. But when she enters \"U\", a massive virtual world, she escapes into her online persona as Belle, a globally-beloved singer.', 121, 'Kaho Nakamura', 'Ryō Narita', 'Shōta Sometani', 'Japan', 'PG', '0000-00-00', 7.1, 'https://www.youtube.com/watch?v=izIycj3j4Ow', 'Belle2021.png', 1),
('BorntoFly2023', 'Born to Fly', 'Adventure', 'Liu Xiaoshi', 'The story of a special operations team headed by elite pilots , being ordered to test new fighter jets. Test flight after test flight, they continue to challenge the sky and the limits of themselves.', 120, 'Wang Yibo', 'Hu Jun', 'Zhou Dongyu', 'China', 'PG-13', '0000-00-00', 7.5, 'https://www.youtube.com/watch?v=3pt3cpD8Pao', 'BorntoFly2023.png', 0),
('Bubble2022', 'Bubble', 'Animation', 'Tetsurō Araki', 'Gravity-defying bubbles rain down, cutting off Tokyo from the rest of the world. The city skyline becomes a playground for young people competing in parkour team battles. Hibiki plummets into the sea but is saved by a girl with mysterious powers.', 100, 'Jun Shison', 'Alice Hirose', 'Mamoru Miyano', 'Japan', 'R-21', '0000-00-00', 6.3, 'https://www.youtube.com/watch?v=8pbWblLkHHk', 'Bubble2022.png', 1),
('DarkPhoenix2019', 'Dark Phoenix', 'Adventure', 'Simon Kinberg', 'After a mishap, Jean Grey is struck by a powerful ray of energy which she absorbs into her body, turning her into an uncontrollable liability for the X-Men.', 116, 'James McAvoy', 'Michael Fassbender', 'Jennifer Lawrence', 'USA', 'PG-13', '0000-00-00', 5.7, 'https://www.youtube.com/watch?v=1-q8C_c-nlM', 'DarkPhoenix2019.png', 0),
('DawnofthePlanetoftheApes2014', 'Dawn of the Planet of the Apes', 'Action', 'Matt Reeves', 'Caesar, a chimpanzee and leader of the evolved apes, allows a human family into his territory. However, due to a vindictive bonobo, misunderstandings arise between the two species, resulting in war.', 130, 'Andy Serkis', 'Jason Clarke', 'Gary Oldman', 'USA', 'PG-13', '0000-00-00', 7.4, 'https://www.youtube.com/watch?v=DpSaTrW4leg', 'DawnofthePlanetoftheApes2014.png', 0),
('DeepSea2023', 'Deep Sea', 'Fantasy', 'Tian Xiaopeng', 'A girl strays into the dreamy deep sea world. In the deepest part of the sea, all secrets are hidden.A girl strays into the dreamy deep sea world.', 112, 'Su Xin', 'Ji Jing', 'Wang Tingwen', 'China', 'PG', '0000-00-00', 7.1, 'https://www.youtube.com/watch?v=d4KTh-2K38c', 'DeepSea2023.png', 1),
('Don\'tWorryDarling2022', 'Don\'t Worry Darling', 'Drama', 'Olivia Wilde', 'In the 1950s, Alice and Jack live in the idealized community of Victory, an experimental company town that houses the men who work on a top-secret project. While the husbands toil away, the wives get to enjoy the beauty, luxury and debauchery of their seemingly perfect paradise. However, when cracks in her idyllic life begin to appear, exposing flashes of something sinister lurking below the surface, Alice can\'t help but question exactly what she\'s doing in Victory.', 123, 'Florence Pugh', 'Harry Styles', 'Chris Pine', 'USA', 'M-18', '0000-00-00', 6.2, 'https://www.youtube.com/watch?v=SZ2elR3OmWI', 'Don\'tWorryDarling2022.png', 0),
('DriftingHome2022', 'Drifting Home', 'Fantasy', 'Hiroyasu Ishida', 'During summer break, sixth graders Kosuke and Natsume play in an apartment building set to be demolished. They find themselves caught up in a strange phenomenon. All they can see around them is a vast sea.', 119, 'Mutsumi Tamura', 'Asami Seto', 'Ayumu Murase', 'Japan', 'PG', '0000-00-00', 6.2, 'https://www.youtube.com/watch?v=BSE2KGU5png&t=2s', 'DriftingHome2022.png', 0),
('Dumb&DumberTo2014', 'Dumb & Dumber To', 'Comedy', 'Peter Farrelly', 'Long-time friends and colossal fools Harry and Lloyd embark on a journey to find Harry\'s newly-discovered daughter and convince her to donate a kidney to Harry, whose health is deteriorating.', 109, 'Jim Carrey', 'Jeff Daniels', 'Rob Riggle', 'USA', 'PG-13', '0000-00-00', 5.6, 'https://www.youtube.com/watch?v=mq1rt4iKuYg', 'Dumb&DumberTo2014.png', 0),
('Dune2021', 'Dune', 'Action', 'Denis Villeneuve', 'A noble family becomes embroiled in a war for control over the galaxy\'s most valuable asset while its heir becomes troubled by visions of a dark future.', 155, 'Timothee Chalamet', 'Rebecca Ferguson', 'Zendaya', 'USA', 'PG-13', '0000-00-00', 8.0, 'https://www.youtube.com/watch?v=n9xhJrPXop4', 'Dune2021.png', 0),
('EdenLodge2015', 'Eden Lodge', 'Horror', 'Andreas Prodromou', 'A young family are stranded at the Eden Lodge. The people they meet are being killed one by one. They must fight to save their marriage, their family, and most of all their lives.', 80, 'Aggy K. Adams.', 'Georgina Blackledge', 'Cyd Casados', 'United Kingdom', 'R-21', '0000-00-00', 3.4, 'https://www.youtube.com/watch?v=yWZg3y94F3E', 'EdenLodge2015.png', 0),
('EDtv1999', 'EDtv', 'Comedy', 'Ron Howard', 'Ed, a video store clerk, is invited for a television show that showcases the life of normal people and his life changes when Cynthia, the show\'s producer, decides to film the entire show on his life.', 124, 'Matthew McConaughey', 'Woody Harrelson', 'Jenna Elfman', 'USA', 'PG-13', '0000-00-00', 5.7, 'https://www.youtube.com/watch?v=V5ZJtWn8zBY', 'EDtv1999.png', 0),
('Elvis2022', 'Elvis', 'Musical', 'Baz Luhrmann', 'Whilst on a mission to transform the mainstream rock and roll culture of the USA, singer Elvis Presley uses his fame to highlight racism within the country.', 159, 'Austin Butler', 'Tom Hanks', 'Olivia DeJonge', 'Australia', 'PG-13', '0000-00-00', 7.3, 'https://www.youtube.com/watch?v=KIsojttVj4o', 'Elvis2022.png', 0),
('EndlessLove2014', 'Endless Love', 'Romance', 'Shana Feste', 'Jade Butterfield is a reclusive young girl who does not socialise much. However, a chance meeting with a former classmate, David, sparks an intimate relationship that alters the course of her life.', 105, 'Alex Pettyfer', 'Gabriella Wilde', 'Bruce Greenwood', 'USA', 'PG-13', '0000-00-00', 6.3, 'https://www.youtube.com/watch?v=NTAzn4W48gc', 'EndlessLove2014.png', 0),
('EscapePlan2013', 'Escape Plan', 'Action', 'Mikael Håfström', 'Ray, an expert in security systems, is framed for a crime and sent to a high-tech prison. However, he uses all his knowledge and special skills with a little inside help to escape the facility.', 115, 'Sylvester Stallone', 'Arnold Schwarzenegger', 'Jim Caviezel', 'USA', 'NC-16', '0000-00-00', 6.7, 'https://www.youtube.com/watch?v=CI4EjV_x_PQ', 'EscapePlan2013.png', 0),
('Fireworks2017', 'Fireworks', 'Romance', 'Nobuyuki Takeuchi', 'Norimichi and Yusuke are both infatuated with their classmate Nazuna. But when Nazuna decides to run away from home, it\'s Norimichi she asks to join her. After their plans go awry, Norimichi discovers a magical ball that has the power to manipulate time and give them a second chance, but each reset brings new complications.', 90, 'Suzu Hirose', 'Masaki Suda', 'Mamoru Miyano', 'Japan', 'PG', '0000-00-00', 5.5, 'https://www.youtube.com/watch?v=KG770hOuT2k', 'Fireworks2017.png', 0),
('Frailty2001', 'Frailty', 'Thriller', 'Bill Paxton', 'One day, a widowed blue-collar worker has a revelation: he must destroy those revealed to him as demons. He then begins the serial killings of `God\'s Hand Killer\' across Texas, but he also has two young sons, the younger of whom idolises him and believes in the cause, while his older brother is revolted but cannot bring himself to stop his father. Twenty years later, the elder son walks into a police station and confesses.', 99, 'Bill Paxton', 'Matthew', 'Powers Boothe', 'USA', 'NC-16', '0000-00-00', 7.2, 'https://www.youtube.com/watch?v=mW6TlPMHXgk', 'Frailty2001.png', 0),
('FullRiverRed2023', 'Full River Red', 'Comedy', 'Yi-Mou Zhang', 'In 12th-century China, an ambassador is killed and a letter meant for the emperor is stolen. As the search for the letter unfolds, alliances are formed, secrets are revealed, and no one can stop the truth that\'s destined to leave its mark on history.', 157, 'Shen Teng', 'Jackson Yee', 'Lei Jiayin', 'China', 'NC-16', '0000-00-00', 6.6, 'https://www.youtube.com/watch?v=Ju3iH89GeUI', 'FullRiverRed2023.png', 0),
('GetShorty1995', 'Get Shorty', 'Crime', 'Barry Sonnenfeld', 'Gangster Chili Palmer travels to Los Angeles and takes on a job offered to him by a movie producer to collect debts. Soon he finds out that his current job is not less than mobbing people.', 105, 'John Travolta', 'Gene Hackman', 'Rene Russo', 'USA', 'PG-13', '0000-00-00', 7.1, 'https://www.youtube.com/watch?v=yNLaTtpovys', 'GetShorty1995.png', 0),
('GlassOnion2022', 'Glass Onion', 'Crime', 'Rian Johnson', 'Tech billionaire Miles Bron invites his friends for a getaway on his private Greek island. When someone turns up dead, Detective Benoit Blanc is put on the case.', 139, 'Daniel Craig', 'Edward Norton', 'Kate Hudson', 'USA', 'PG-13', '0000-00-00', 7.2, 'https://www.youtube.com/watch?v=gj5ibYSz8C0', 'GlassOnion2022.png', 0),
('GosfordPark2002', 'Gosford Park', 'Mystery', 'Robert Altman', 'Sir William McCordle and his family plan a shooting party over a weekend. Their family secrets, lies and deceptions come tumbling out when Sir William gets murdered.', 137, 'Eileen Atkins', 'Bob Balaban', 'Alan Bates', 'United Kingdom', 'PG-13', '0000-00-00', 7.2, 'https://www.youtube.com/watch?v=nqXMOuxstdI', 'GosfordPark2002.png', 0),
('HerBlueSky2019', 'Her Blue Sky', 'Animation', 'Tatsuyuki Nagai', 'When their parents died, Akane remained in her hometown to take care of her little sister, Aoi. Years later, Akane\'s ex-boyfriend, Shinnosuke, returns to town to perform at a music festival. At the same time as the re-encounter between the two former lovers, Aoi meets Shinnosuke\'s teenage self, who has traveled through time, and she falls head over heels for him. The team from the moving The Anthem of the Heart returns with a surprising story full of romance and youthful longings.', 106, 'Shion Wakayama', 'Riho Yoshioka', 'Ryo Yoshizawa', 'Japan', 'PG', '0000-00-00', 7.5, 'https://www.youtube.com/watch?v=YGzSrGnIm5M', 'HerBlueSky2019.png', 0),
('Highway2014', 'Highway', 'Romance', 'Imtiaz Ali', 'Veera, a young bride-to-be, is abducted by a local gangster, Mahabir, and his men a day prior to her wedding. Far from being terrified of her abductor, Veera discovers a new meaning to her life.', 133, 'Alia Bhatt', 'Randeep Hooda', 'Durgesh Kumar', 'India', 'PG-13', '0000-00-00', 7.6, 'https://www.youtube.com/watch?v=LSrDD52bx4A', 'Highway2014.png', 0),
('IdleHands1999', 'Idle Hands', 'Horror', 'Rodman Flender', 'A teenaged slacker finds his parents turned into headless Halloween decorations and realises that his right hand has a blood-thirsty mind of its own that wreaks havoc.', 92, 'Devin Sawa', 'Seth', 'Elden Henson', 'USA', 'PG-13', '0000-00-00', 6.2, 'https://www.youtube.com/watch?v=HcVrp--9UUc', 'IdleHands1999.png', 0),
('Inkheart2008', 'Inkheart', 'Fantasy', 'Iain Softley', 'Mo, who can bring book characters to life, accidentally sets free the evil Capricorn. Ten years later, his daughter Meggie, her aunt and the book\'s hero set out to help her father trap the villain.', 106, 'Brendan Fraser', 'Paul Bettany', 'Helen Mirren', 'United Kingdom', 'PG', '0000-00-00', 6.1, 'https://www.youtube.com/watch?v=7UvKccFUC2I', 'Inkheart2008.png', 0),
('Kite2014', 'Kite', 'Thriller', 'Ralph Ziman', 'When her parents are brutally murdered by unknown assailants, Sawa, a young girl, teams up with her father\'s ex-partner and scours the nefarious human trafficking world to find the murderers.', 90, 'India Eisley', 'Callan McAuliffe', 'Samual L. Jackson', 'South Africa', 'R-21', '0000-00-00', 4.4, 'https://www.youtube.com/watch?v=l0l7uphJ-Wg', 'Kite2014.png', 0),
('KungFuYoga2017', 'Kung Fu Yoga', 'Action', 'Stanley Tong', 'When Jack, an archaeology professor, teams up with an Indian professor to discover India\'s lost treasure, they are ambushed. Jack uses his kung fu knowledge to flee and locate the treasure.', 108, 'Jackie Chan', 'Lay Zhang', 'Aarif Rahman', 'China', 'PG-13', '0000-00-00', 7.1, 'https://www.youtube.com/watch?v=DkPluechlNY', 'KungFuYoga2017.png', 0),
('LegendsofOz:Dorothy\'sReturn2014', 'Legends of Oz: Dorothy\'s Return', 'Adventure', 'Will Finn', 'Legends of Oz: Dorothy\'s Return is a 2013 computer-animated musical fantasy film that is loosely based on the 1989 book Dorothy of Oz by L. Frank Baum\'s great-grandson Roger Stanton Baum. ', 88, 'Lea Michele', 'Patrick Stewart', 'Jim Belushi', 'USA', 'PG', '0000-00-00', 5.0, 'https://www.youtube.com/watch?v=HN7xNSNsWGA', 'LegendsofOz-Dorothy\'sReturn2014.png', 0),
('LetterstoGod2010', 'Letters to God', 'Drama', 'David Nixon', 'A young boy who has cancer decides to write letters to God to help him through the situation. A postman picks up the first letter and is clueless about what to do with it.', 110, 'Robyn Lively', 'Jeffrey S.S. Johnson', 'Maree Cheatham', 'USA', 'PG-13', '0000-00-00', 6.1, 'https://www.youtube.com/watch?v=RlKf6eL4RSg', 'LetterstoGod2010.png', 0),
('LightfromtheDarkroom2014', 'Light from the Darkroom', 'Action', 'Lance McDaniel', 'Light in the Darkroom is the story of two best friends whose faith is tested when their friends disappear during a religious pilgrimage.', 110, 'Lymari Nadal', 'Patricia De Leon', 'Steven Michael Quezada', 'USA', 'PG-13', '0000-00-00', 6.8, 'https://www.youtube.com/watch?v=kcMcY2tRXas', 'LightfromtheDarkroom2014.png', 0),
('LordsofLondon2014', 'Lords of London', 'Mystery', 'Antonio Simoncini', 'Tony Lord, a gangster, is transported back to his childhood days where he is forced to confront his father\'s misdeeds in order to make his own life free of crime and abuse.', 90, 'Glen Murphy', 'Ray Winstone', 'Serena Iansiti', 'USA', 'PG-13', '0000-00-00', 3.2, 'https://www.youtube.com/watch?v=W8U2pP7c-Cg', 'LordsofLondon2014.png', 0),
('LosmenMelati2023', 'Losmen Melati', 'Horror', 'Billy Christian', 'Travelers looking for lodging. They then found the Melati Inn and became guests there. Until one day they realized that if they were in there, they would never get out again.', 98, 'Alexandra Gottardo', ' Kiki Narendra', 'Fandy Christian', 'Indonesia', 'NC-16', '0000-00-00', 7.9, 'https://www.youtube.com/watch?v=nkdrMavzKaM', 'LosmenMelati2023.png', 0),
('Lupinthe3rdvs.Cat\'sEye2023', 'Lupin the 3rd vs. Cat\'s Eye', 'Animation', 'Yuji Ohno', 'The Cat\'s Eye sisters are again aiming to steal the three paintings that once belonged to their father. Only this time, Lupin III is also after the same trio of paintings. The paintings in question will also reveal a long-buried mystery.', 92, 'Kan\'ichi Kurita', 'Keiko Toda', 'Akio Ôtsuka', 'Japan', 'PG-13', '0000-00-00', 6.1, 'https://www.youtube.com/watch?v=1IioBvbiarE', 'Lupinthe3rdvs.Cat\'sEye2023.png', 0),
('Maggie2015', 'Maggie', 'Horror', 'Henry Hobson', 'A man takes extreme steps to protect Maggie, his daughter, who is slowly turning into a cannibal after a zombie attack. He spends time with her, reminiscing about her childhood, dreading the future.', 95, 'Arnold Schwarzenegger', 'Abigail Breslin', 'Joely Richardson', 'USA', 'PG-13', '0000-00-00', 5.6, 'https://www.youtube.com/watch?v=AQ5Vz8qE8R8', 'Maggie2015.png', 0),
('MasterandCommander:TheFarSideoftheWorld2003', 'Master and Commander: The Far Side of the World', 'Adventure', 'Peter Weir', 'Captain Jack Aubrey orders his team to set out in search of a French war vessel. However, when his own ship is heavily damaged, he realises the task is not as easy as it seems.', 138, 'Russell Crowe', 'Paul Bettany', 'Max Pirkis', 'USA', 'PG', '0000-00-00', 7.4, 'https://www.youtube.com/watch?v=tHTHCNYiiHk', 'MasterandCommander-TheFarSideoftheWorld2003.png', 0),
('Mirai2018', 'Mirai', 'Adventure', 'Mamoru Hosoda', 'A young boy named Kun feels forgotten by his family when his little sister Mirai arrives. Running away from home, Kun stumbles upon a magical garden that serves as a time-travelling gateway where he encounters his mother as a little girl and has a series of adventures with his baby sister, who is all grown up, opening a new perspective on his world.', 98, 'Moka Kamishiraishi', 'Haru Kuroki', 'Gen Hoshino', 'Japan', 'PG', '0000-00-00', 7.0, 'https://www.youtube.com/watch?v=6d-lsJZgmJs', 'Mirai2018.png', 0),
('MissPotter2006', 'Miss Potter', 'Romance', 'Chris Noonan', 'Beatrix Potter writes stories since she was a child but never got any recognition. Her life changes when a publisher decides to compile and publish her stories.', 92, 'Renée Zellweger', 'Ewan McGregor', 'Emily Watson', 'United Kingdom', 'PG-13', '0000-00-00', 7.0, 'https://www.youtube.com/watch?v=BMDDdMprkY4', 'MissPotter2006.png', 0),
('Mission:Impossible-RogueNation2015', 'Mission: Impossible - Rogue Nation', 'Action', 'Christopher McQuarrie', 'With the IMF disbanded and the CIA hunting him, Ethan and his team race against time to prove the existence of the Syndicate, a highly-skilled terror organisation, before they plan their next attack.', 132, 'Tom Cruise', 'Rebecca Ferguson', 'Simon Pegg', 'USA', 'PG-13', '0000-00-00', 7.4, 'https://www.youtube.com/watch?v=pXwaKB7YOjw', 'Mission-Impossible-RogueNation2015.png', 0),
('Moonman2022', 'Moon man', 'Sci-Fi', 'Chiyu Zhang', 'After being left unexpectedly on the moon, an asteroid destroys the earth, leaving Duguyue being the last person in existence.', 122, 'Shen Teng', 'Ma Li', 'Chang Yuan', 'China', 'PG-13', '0000-00-00', 8.2, 'https://www.youtube.com/watch?v=254pTHplAa0', 'Moonman2022.png', 0),
('MozartfromSpace2022', 'Mozart from Space', 'Fantasy', 'Chen Sicheng', 'A young boy takes a keen interest in astronomy, but his father wants him to play piano. One day, a mysterious alien arrives and helps the boy overcome his differences with his father.', 136, 'Huang Bo', 'Rong Zishan', 'Fan Tiantian', 'China', 'PG-13', '0000-00-00', 7.8, 'https://www.youtube.com/watch?v=nl4Pxrqyw7U', 'MozartfromSpace2022.png', 0),
('Mr.Peabody&Sherman2014', 'Mr. Peabody & Sherman', 'Adventure', 'Rob Minkoff', 'A talking dog, Mr Peabody, embarks on a life dedicated to science, technology and athletics after being rejected by a potential owner. He adopts a son, Sherman.', 92, 'Max Charles', 'Ty Burrell', 'Ariel Winter', 'USA', 'PG', '0000-00-00', 6.8, 'https://www.youtube.com/watch?v=hy6oD7BZw50', 'Mr.Peabody&Sherman2014.png', 0),
('N-Secure2010', 'N-Secure', 'Drama', 'David M. Matthews', 'This film sheds light on a man\'s downfall from the pinnacles of success into the depths of his damaged character. His insecurities lead him into a series of troubled romantic relationships and eventually a web of events that include betrayal and murder.', 116, 'Essence Atkins', 'Cordel Moore', 'Denise Boutte', 'USA', 'PG-13', '0000-00-00', 3.7, 'https://www.youtube.com/watch?v=6wJrbsC8IgQ', 'N-Secure2010.png', 0),
('Neal\'N\'Nikki2005', 'Neal \'N\' Nikki', 'Comedy', 'Arjun Sablok', 'During a 21-day bachelor trip before his wedding, Neal falls in love with Nikki, a woman he slept with. Things get further complicated when Nikki turns out to be his fiancee\'s cousin.', 124, 'Uday Chopra', 'Tanishaa Mukerji', 'Richa Pallod', 'India', 'R-21', '0000-00-00', 3.3, 'https://www.youtube.com/watch?v=6gp7MfbCTDU', 'Neal\'N\'Nikki2005.png', 0),
('Pearl2022', 'Pearl', 'Horror', 'Ti West', 'Trapped on her family\'s isolated farm, Pearl must tend to her ailing father under the bitter and overbearing watch of her devout mother. Lusting for a glamorous life like she\'s seen in the movies, Pearl finds her ambitions, temptations, and repressions all colliding in this origin story of X\'s iconic villain.', 103, 'Mia Goth', 'David Corenswet', 'Tandi Wright', 'USA', 'R-21', '0000-00-00', 7.0, 'https://www.youtube.com/watch?v=L5PW5r3pEOg', 'Pearl2022.png', 0),
('PoundofFlesh2015', 'Pound of Flesh', 'Action', 'Ernie Barbarash', 'A former black-ops agent (Jean-Claude Van Damme) begins a blood-soaked quest to find the organ thieves who stole his kidney before he could donate it to his dying niece.', 104, 'Jean-Claude Van Damme', 'John Ralson', 'Charlotte Peters', 'Canada', 'NC-16', '0000-00-00', 5.1, 'https://www.youtube.com/watch?v=RpTrypbMr-Q', 'PoundofFlesh2015.png', 0),
('RebaMcEntire\'sTheHammer2023', 'Reba McEntire\'s The Hammer', 'Crime', 'Jeff Beesley', 'Kim Wheeler, an attorney who is appointed as a judge for Nevada\'s 5th district after the former judge\'s death. As the investigation into the death intensifies, Kim\'s sister, who runs the local brothel, becomes the prime suspect.', 85, 'Rebe McEntire', 'Melissa Peterman', 'Rex Linn', 'USA', 'NC-16', '0000-00-00', 7.1, 'https://www.youtube.com/watch?v=jP7MudaCsx0', 'RebaMcEntire\'sTheHammer2023.png', 0),
('ReservoirDogs1992', 'Reservoir Dogs', 'Crime', 'Quentin Tarantino', 'Six criminals, hired to steal diamonds, do not know each other\'s true identity. While attempting the heist, the police ambushes them, leading them to believe that one of them is an undercover officer.', 99, 'Harvey Keitel', 'Tim Roth', 'Chris Penn', 'USA', 'PG-13', '0000-00-00', 8.3, 'https://www.youtube.com/watch?v=GLPJSmUHZvU', 'ReservoirDogs1992.png', 0),
('RideOn2023', 'Ride On', 'Adventure', 'Larry Yang', 'Washed-up stuntman Luo can barely make ends meet, let alone take care of his beloved stunt horse, Red Hare. Luo reluctantly seeks help from his estranged daughter and her lawyer boyfriend when notified the horse may be auctioned off to pay his debts. Luo and Red Hare become an overnight media sensation when their fight with debt collectors goes viral.', 126, 'Jackie Chan', 'Liu Haocun', 'Guo Qilin', 'China', 'PG-13', '0000-00-00', 8.6, 'https://www.youtube.com/watch?v=k5aVcHpl_Xw', 'RideOn2023.png', 0),
('Roadside2013', 'Roadside', 'Horror', 'Eric England', 'Dan and his pregnant wife are on a road trip. Along a deserted road, they stop due to a fallen tree. Soon, they are held hostage by a gunman and must fight for their lives.', 90, 'Eric England', 'Ace Marrero', 'Katie Stegeman', 'USA', 'NC-16', '0000-00-00', 3.8, 'https://www.youtube.com/watch?v=HpddoSak0AQ', 'Roadside2013.png', 0),
('Roar2014', 'Roar', 'Thriller', 'Kamal Sadanah', 'A commando team enters the jungle to track down a white tigress after she kills a man. They do not realize how smart the tigress is, and soon the hunters become the hunted.', 123, 'Aaran Chaudhary', 'Nora Fatehi', 'Himarsha Venkatsamy', 'India', 'PG', '0000-00-00', 5.5, 'https://www.youtube.com/watch?v=cny_D50Rr44', 'Roar2014.png', 0),
('Sakra2023', 'Sakra ', 'Adventure', 'Donnie Yen', 'Accused of murder, a martial artist goes on the run in search of answers about his own mysterious origins and the unknown enemies out to destroy him.', 130, 'Sheng Lingzhi', 'Zhu Wei', 'He Ben', 'China', 'NC-16', '0000-00-00', 5.9, 'https://www.youtube.com/watch?v=ecpoT3OE3y8', 'Sakra2023.png', 0),
('Saw2004', 'Saw', 'Horror', 'James Wan', 'The film tells a nonlinear narrative, revolving around the mystery of the Jigsaw Killer, who tests his victims\' will to live by putting them through deadly \"games\" where they must inflict great physical pain upon themselves to survive. The frame story follows Jigsaw\'s latest victims (Whannell and Elwes), who awaken in a large, dilapidated bathroom, with one being ordered to kill the other to save his own family.', 103, 'Cary Elwes', 'Danny Glover', 'Monica Potter', 'USA', 'NC-16', '0000-00-00', 6.1, 'https://www.youtube.com/watch?v=S-1QgOMQ-ls', 'Saw2004.png', 0),
('Scream2022', 'Scream', 'Horror', 'Matt Bettinelli-Olpin', 'Twenty-five years after a streak of brutal murders shocked the quiet town of Woodsboro, Calif., a new killer dons the Ghostface mask and begins targeting a group of teenagers to resurrect secrets from the town\'s deadly past.', 94, 'Courteney Cox', 'Melissa Barrera', 'Jenna Ortega', 'USA', 'M-18', '0000-00-00', 6.3, 'https://www.youtube.com/watch?v=beToTslH17s', 'Scream2022.png', 1),
('ScreamVI2023', 'Scream VI', 'Horror', 'Matt Bettinelli-Olpin', 'In the next installment, the survivors of the Ghostface killings leave Woodsboro behind and start a fresh chapter in New York City.', 122, 'Courteney Cox', 'Melissa Barrera', 'Jenna Ortega', 'USA', 'M-18', '0000-00-00', 7.1, 'https://www.youtube.com/watch?v=h74AXqw4Opc', 'ScreamVI2023.png', 0),
('Senior2015', 'Senior', 'Horror', 'Wisit Sasanatieng', 'A student who can smell ghosts work together with a dead senior classmate to investigate a murder from 50 years ago.', 104, 'Jannine Weigel', 'Phongsakon Tosuwan', 'Sa-ad Piampongsan', 'Thailand', 'PG-13', '0000-00-00', 7.8, 'https://www.youtube.com/watch?v=zni_QolQV0k', 'Senior2015.png', 0),
('Serenity2019', 'Serenity', 'Thriller', 'Steven Knight', 'Baker Dill is a fishing boat captain who leads tours off of the tranquil enclave of Plymouth Island. His peaceful life is soon shattered when his ex-wife Karen tracks him down. Desperate for help, Karen begs Baker to save her -- and their young son -- from her abusive husband. She wants him to take the brute out for a fishing excursion -- then throw him overboard to the sharks. Thrust back into a life that he wanted to forget, Baker now finds himself struggling to choose between right and wrong.', 106, 'Matthew McConaughey', 'Anne Hathaway', 'Diane Lane', 'USA', 'M-18', '0000-00-00', 5.4, 'https://www.youtube.com/watch?v=k3zMlsEK8xA', 'Serenity2019.png', 0),
('ShallWeDance2004', 'Shall We Dance', 'Romance', 'Peter Chelsom', 'John, a bored and overworked estate lawyer, sees a beautiful woman standing at the window of a dance studio on a daily basis. He signs up for ballroom dancing lessons with hopes of meeting her.', 106, 'Richard Gere', 'Jennifer Lopez', 'Susan Sarandon', 'USA', 'PG', '0000-00-00', 6.2, 'https://www.youtube.com/watch?v=y-A64ctS2Cc', 'ShallWeDance2004.png', 0),
('ShortCuttoNirvana:KumbhMela2004', 'Short Cut to Nirvana: Kumbh Mela', 'Biography', 'Nick Day', 'Every 12 years over 70 million pilgrims gather at the meeting of India\'s holiest rivers, the Ganges and the Yamuna, for a spectacular spiritual festival: the Kumbh Mela. This documentary takes a voyage of discovery through this colorful event through the eyes of several Westerners and an ebullient young Hindu monk, Swami Krishnanand. Featuring encounters with some of India\'s most respected holy men and exclusive footage of His Holiness the Dalai Lama.', 85, 'Jasper Johal', 'Justin Davis', 'Swami Krishnanad', 'USA', 'PG-13', '0000-00-00', 7.0, 'https://www.youtube.com/watch?v=_eeZUJliReQ', 'ShortCuttoNirvana-KumbhMela2004.png', 0),
('Sing22021', 'Sing 2', 'Animation', 'Garth Jennings', 'Buster Moon and his friends must persuade reclusive rock star Clay Calloway to join them for the opening of a new show.', 110, 'Matthew McConaughey', 'Scarlett Johansson', 'Tori Kelly', 'USA', 'PG', '0000-00-00', 7.4, 'https://www.youtube.com/watch?v=EPZu5MA2uqI', 'Sing22021.png', 0),
('Sister2021', 'Sister', 'Family', 'Ruoxin Yin', 'A girl who has lost her parents is facing the issue of pursuing an independent life or raising her younger brother.', 127, 'Zhang Zifeng', 'Xiao Yang', 'Zhu Yuanyuan', 'China', 'PG-13', '0000-00-00', 8.0, 'https://www.youtube.com/watch?v=COLOJaM3k_M', 'Sister2021.png', 0),
('Slumberland2022', 'Slumberland', 'Fantasy', 'Francis Lawrence', 'A young girl discovers a secret map to the dreamworld of Slumberland, and with the help of an eccentric outlaw, she traverses dreams and flees nightmares, with the hope that she will be able to see her late father again.', 117, 'Jason Momoa', 'Chris O\'Dowd', 'Chris O\'Dowd', 'USA', 'PG', '0000-00-00', 6.7, 'https://www.youtube.com/watch?v=FBnkVJslRGo', 'Slumberland2022.png', 0),
('SoundofMyVoice2011', 'Sound of My Voice', 'Drama', 'Zal Batmanglij', 'California couple Peter (Christopher Denham) and Lorna (Nicole Vicius) set out to make a documentary meant to expose a charismatic cult leader named Maggie (Brit Marling) as a fraud. Maggie claims to be from the year 2054 and is seemingly allergic to almost everything in her environment; she lives in a basement, subsisting on canned oxygen, homegrown food and the blood of her acolytes. Though at first, Peter and Lorna are adamant that Maggie is a fake, they both soon fall under her spell.', 85, 'Christopher Denham', 'Nicole Vicius', 'Brit Marling', 'USA', 'PG-13', '0000-00-00', 6.6, 'https://www.youtube.com/watch?v=r0eEDovkvIs', 'SoundofMyVoice2011.png', 0),
('Spider-Man:NoWayHome2021', 'Spider-Man: No Way Home', 'Action', 'Jon Watts', 'With Spider-Man\'s identity now revealed, Peter asks Doctor Strange for help. When a spell goes wrong, dangerous foes from other worlds start to appear, forcing Peter to discover what it truly means to be Spider-Man.', 148, 'Tom Holland', 'Zendaya', 'Benedict Cumberbatch', 'USA', 'PG-13', '0000-00-00', 8.2, 'https://www.youtube.com/watch?v=JfVOs4VSpmA', 'Spider-Man-NoWayHome2021.png', 0),
('SpiritUntamed2021', 'Spirit Untamed', 'Adventure', 'Elaine Bogan', 'After moving to a sleepy little town, young Lucky Prescott befriends a wild mustang named Spirit, who shares her rebellious spirit. When a heartless wrangler plans to capture Spirit and his herd, Lucky and her new friends embark on the adventure of a lifetime to rescue the horse that forever changed her life.', 85, 'Isabela Merced', 'Marsai Martin', 'Mckenna Grace', 'USA', 'PG', '0000-00-00', 5.5, 'https://www.youtube.com/watch?v=9jG1nnQGpdI', 'SpiritUntamed2021.png', 0),
('StateofPlay2009', 'State of Play', 'Thriller', 'Kevin Macdonald', 'When a US Congressman\'s aide gets killed, a team of reporters joins forces with the police to investigate the case. As they delve deep into the mystery, the politician\'s dark secrets come pouring out.', 128, 'Russell Crowe', 'Ben Affleck', 'Rachel McAdams', 'United Kingdom', 'PG', '0000-00-00', 7.1, 'https://www.youtube.com/watch?v=s1Sp1QvyQQI', 'StateofPlay2009.png', 0),
('StepBrothers2008', 'Step Brothers', 'Comedy', 'Adam McKay', 'Brennan and Dale, two middle-aged men who still live with their parents, are forced to stay under the same roof together when Brennan\'s mother marries Dale\'s father.', 98, 'Will Ferrell', 'Richard Jenkins', 'John C. Reilly', 'USA', 'M-18', '0000-00-00', 6.9, 'https://www.youtube.com/watch?v=8QKE96wZTkw', 'StepBrothers2008.png', 0),
('StepUp:YearOfTheDance2019', 'Step Up: Year Of The Dance', 'Musical', 'Ron Yuan', 'Step Up: Year of the Dance explodes onto the streets and stages of Beijing with super-talented young performers and dazzling dance sequences as a group of feisty street dancers join forces for a battle royal to determine the world\'s best dance crew.', 100, 'Jade Chynoweth', 'Sean Lew', 'Meiqi Meng', 'China', 'PG-13', '0000-00-00', 3.7, 'https://www.youtube.com/watch?v=jRlVV38txiQ', 'StepUp-YearOfTheDance2019.png', 0),
('SuperSizeMe2004', 'Super Size Me', 'Documentary', 'Morgan Spurlock', 'Director Morgan Spurlock\'s social experiment in fast-food gastronomy sees him attempting to subsist uniquely on food from the McDonald\'s menu for an entire month. In the process his weight balloons, his energy level plummets and he experiences all sorts of unexpected -- and terrifying -- side effects. He also examines the corporate giant\'s growing role in the lives of American consumers and explores its methods of indoctrinating young people and its contribution to America\'s obesity epidemic.', 98, 'Morgan Spurlock', 'Alexandra Jamieson', '', 'USA', 'PG-13', '0000-00-00', 7.2, 'https://www.youtube.com/watch?v=oAjsBZEOnVw', 'SuperSizeMe2004.png', 0),
('Suzume2023', 'Suzume', 'Animation', 'Makoto Shinkai', 'As the skies turn red and the planet trembles, Japan stands on the brink of disaster. However, a determined teenager named Suzume sets out on a mission to save her country. Able to see supernatural forces that others cannot, it\'s up to her to close the mysterious doors that are spreading chaos across the land. A perilous journey awaits as the fate of Japan rests on her shoulders.', 122, 'Nanoka Hara', 'Hokuto Matsumura', 'Eri Fukatsu', 'Japan', 'PG', '0000-00-00', 7.7, 'https://www.youtube.com/watch?v=5pTcio2hTSw', 'Suzume2023.png', 0),
('TearsoftheSun2003', 'Tears of the Sun', 'Action', 'Antonie Fuqua', 'Lt A K Waters and his troop are tasked to rescue Dr Lena from the jungles of a conflict-ridden Nigeria. However, she refuses to go with them unless they rescue her patients too.', 121, 'Bruce Willis', 'Cole Hauser', 'Monica Bellucci', 'USA', 'PG-13', '0000-00-00', 6.6, 'https://www.youtube.com/watch?v=INW4f3yyeZg', 'TearsoftheSun2003.png', 0),
('Tetris2023', 'Tetris', 'Drama', 'Jon S. Baird', 'The story of how one of the world\'s most popular video games found its way to players around the globe. Businessman Henk Rogers and Tetris inventor Alexey Pajitnov join forces in the USSR, risking it all to bring Tetris to the masses.', 118, 'Taron Egerton', 'Mara Huf', 'Miles Barrow', 'USA', 'R-21', '0000-00-00', 7.4, 'https://www.youtube.com/watch?v=FE8yoLsJX_k', 'Tetris2023.png', 0),
('TheBourneSupremacy2004', 'The Bourne Supremacy', 'Action', 'Paul Greengrass', 'When he is falsely framed in a CIA operation, Jason Bourne is forced to return to his old ways as an assassin, in order to figure out why they are still after him.', 108, 'Matt Damon', 'Brian Cox', 'Franka Potente', 'USA', 'PG-13', '0000-00-00', 7.7, 'https://www.youtube.com/watch?v=ohkW_xbPl9A', 'TheBourneSupremacy2004.png', 0),
('TheBrothersGrimm2005', 'The Brothers Grimm', 'Fantasy', 'Terry Gilliam', 'Brothers Jake and Will Grimm, who cheat people with tales of enchanted creatures and exorcisms, are put to the test when they encounter a real magical curse and must kill the evil queen to end it.', 118, 'Matt Damon', 'Heath Ledger', 'Lena Headey', 'USA', 'PG-13', '0000-00-00', 5.9, 'https://www.youtube.com/watch?v=ohxNxVlk2GQ', 'TheBrothersGrimm2005.png', 0),
('TheBossBaby2017', 'The Boss Baby', 'Family', 'Tom McGrath', 'Seven-year-old Tim gets jealous when his parents give all their attention to his little brother. Tim soon learns that the baby can talk and the two team up to foil the plans of the CEO of Puppy Co.', 97, 'Alec Baldwin', 'Tom McGrath', 'Tobey Maguire', 'USA', 'PG', '0000-00-00', 6.3, 'https://www.youtube.com/watch?v=k397HRbTtWI', 'TheBossBaby2017.png', 0),
('TheCave2019', 'The Cave', 'Adventure', 'Tom Waller', 'Twelve boys and their football coach become trapped in a northern Thailand cave by flood waters, and an international team of rescue workers scramble to save them.', 104, 'Jim Warny', 'Ekawat Niratvorapanya', 'Tan Xiaolong', 'Thailand', 'PG-13', '0000-00-00', 5.3, 'https://www.youtube.com/watch?v=TaZkwBWuN2A', 'TheCave2019.png', 0),
('TheDeparted2006', 'The Departed', 'Crime', 'Martin Scorsese', 'An undercover agent and a spy constantly try to counter-attack each other in order to save themselves from being exposed in front of the authorities. Meanwhile, both try to infiltrate an Irish gang.', 95, 'Leonardo DiCaprio', 'Matt Damon', 'Jack Nicholson', 'USA', 'M-18', '0000-00-00', 8.5, 'https://www.youtube.com/watch?v=iQpb1LoeVUc', 'TheDeparted2006.png', 0),
('TheFighter2010', 'The Fighter', 'Drama', 'David O. Russell', 'Micky Ward, a struggling boxer, teams up with his older half-brother Dicky Eklund, a recovering cocaine addict, to get his career back on track.', 116, 'Mark Wahlberg', 'Christian Bale', 'Amy Adams', 'USA', 'M-18', '0000-00-00', 7.8, 'https://www.youtube.com/watch?v=LRIZ4mCi5Ps', 'TheFighter2010.png', 0),
('TheIsland2018', 'The Island', 'Comedy', 'Huang Bo', 'News of a meteorite bound to strike Earth doesn\'t have much effect on Ma Jin\'s everyday life; he still gets up and goes to a job where he spends his time daydreaming of a romance with his colleague Shanshan, and of winning the lottery. But when this cataclysmic event occurs during a team-building trip, he finds himself shipwrecked on an island with an odd group of co-workers, and he has the winning lottery ticket in his pocket.', 134, 'Huang Bo', 'Shu Qi', 'Lay Zhang', 'China', 'PG-13', '0000-00-00', 6.2, 'https://www.youtube.com/watch?v=lLtNiDDb5yk', 'TheIsland2018.png', 0),
('TheKillerInsideMe2010', 'The Killer Inside Me', 'Thriller', 'Michael Winterbottom', 'Darkly disturbing thriller set in Texas. When the son of local wealthy mogul Chester Conway is found dead with the beaten body of a local prostitute, suspicion falls onto Deputy Sheriff Lou Ford - who until now was thought of as a stoic pillar in the community. The Sheriff is revealed to be a cunning, sadistic sociopath.', 109, 'Casey Affleck', 'Kate Hudson', 'Jessica Alba', 'USA', 'R-21', '0000-00-00', 6.1, 'https://www.youtube.com/watch?v=1I4rDHxzeCg', 'TheKillerInsideMe2010.png', 0),
('TheLoneRanger2013', 'The Lone Ranger', 'Action', 'Gore Verbinski', 'John, a lawyer, joins his brother to capture Cavendish, an outlaw. Cavendish attacks and leaves them for dead but John is rescued by Tonto, a rebel Comanche, and they team up to take down the rogue.', 149, 'Johnny Depp', 'Armie Hammer', 'Tom Wilkinson', 'USA', 'PG-13', '0000-00-00', 6.4, 'https://www.youtube.com/watch?v=L9DDCKVrZfU', 'TheLoneRanger2013.png', 0),
('TheMummy:TomboftheDragonEmperor2008', 'The Mummy: Tomb of the Dragon Emperor', 'Adventure', 'Rob Cohen', 'After being asked to visit China with a precious relic, which can bring people back from the dead, Alex O\'Connell discovers an ancient tomb and accidentally resurrects a mummy.', 112, 'Brendan Fraser', 'Jet Li', 'Maria Bello', 'USA', 'PG-13', '0000-00-00', 5.2, 'https://www.youtube.com/watch?v=5-4qSE2Ch0Y', 'TheMummy-TomboftheDragonEmperor2008.png', 0),
('TheNameofLove2010', 'The Name of Love', 'Comedy', 'Michel Leclerc', 'In her attempts to convert her political opponents, provocative activist Bahia openly flirts and sleeps with those who don\'t agree with her until they change their mind. However, everything changes when she meets an uptight scientist.', 100, 'Jacques Gamblin', 'Sara Forestier', 'Zinedine Soualem', 'France', 'NC-16', '0000-00-00', 7.1, 'https://www.youtube.com/watch?v=qXjH64Wu2gY', 'TheNameofLove2010.png', 0),
('TheNutcrackerandtheFourRealms2018', 'The Nutcracker and the Four Realms', 'Fantasy', 'Joe Johnston', 'On Christmas Eve, Clara realises that before dying, her mother left her with an inheritance to a magical world of fairies and toy soldiers that are alive. She holds the key to the fate of this world.', 100, 'Mackenzie Foy', 'Keira Knightley', 'Misty Copeland', 'USA', 'PG', '0000-00-00', 5.6, 'https://www.youtube.com/watch?v=BXfxLIuNJvw', 'TheNutcrackerandtheFourRealms2018.png', 0),
('ThePeanutsMovie2015', 'The Peanuts Movie', 'Comedy', 'Steve Martino', 'Charlie falls for a red-haired girl, who moves into his neighbourhood, and tries to woo her. Meanwhile, his best friend Snoopy, with the help of his team, sets out to pursue his arch-rival, Red Baron.', 93, 'Noah Schnapp', 'Hadley Belle Miller', 'Mariel Sheets', 'USA', 'PG', '0000-00-00', 7.0, 'https://www.youtube.com/watch?v=zQpUQPrAfQM', 'ThePeanutsMovie2015.png', 1),
('ThePope\'sExorcist2023', 'The Pope\'s Exorcist ', 'Horror', 'Julius Avery', 'Father Gabriele Amorth, chief exorcist for the Vatican, battles Satan and innocent-possessing demons. A detailed portrait of a priest who performed more than 100,000 exorcisms in his lifetime.', 103, 'Russell Crowe', 'Daniel Zovatto', 'Alex Essoe', 'USA', 'NC-16', '0000-00-00', 6.1, 'https://www.youtube.com/watch?v=YJXqvnT_rsk', 'ThePope\'sExorcist2023.png', 0),
('TheReef2010', 'The Reef', 'Horror', 'Andrew Traucki', 'The Reef is a 2010 Australian survival horror film, written, directed and produced by Andrew Traucki in his second feature film. The film is about a group of friends who capsize while sailing to Indonesia and are stalked by a great white shark as they try to swim to a nearby island.', 94, 'Damian Walshe-Howling', 'Zoe Naylor', 'Gyton Grantley', 'Australia', 'NC-16', '0000-00-00', 5.8, 'https://www.youtube.com/watch?v=0UD2gbjB3vw', 'TheReef2010.png', 0),
('TheSuperMarioBros.Movie2023', 'The Super Mario Bros. Movie', 'Animation', 'Aaron Horvath', 'With help from Princess Peach, Mario gets ready to square off against the all-powerful Bowser to stop his plans from conquering the world.', 92, 'Chris Pratt', 'Anya Taylor Joy', 'Charlie Day', 'USA', 'PG', '0000-00-00', 7.4, 'https://www.youtube.com/watch?v=TnGl01FkMMo', 'TheSuperMarioBros.Movie2023.png', 0),
('TheWatch2012', 'The Watch', 'Sci-Fi', 'Akiva Schaffer', 'After his store\'s watchman is murdered, Evan along with his neighbours forms a neighbourhood watch. They soon realise that the murderer is not a human, but an alien.', 102, 'Ben Stiller', 'Vince Vaughn', 'Jonah Hill', 'USA', 'PG-13', '0000-00-00', 5.7, 'https://www.youtube.com/watch?v=PhN1xnCyqR8', 'TheWatch2012.png', 0),
('TigerOrange2014', 'Tiger Orange', 'Drama', 'Wade Gasque', 'Two estranged gay brothers struggle to reconnect in their small California hometown after their father\'s death.', 76, 'Mark Strano', 'Johnny Hazzard', 'Gregory Marcel', 'USA', 'M-18', '0000-00-00', 6.5, 'https://www.youtube.com/watch?v=Ht5s3lcMpqo', 'TigerOrange2014.png', 0),
('TomandJerry2021', 'Tom and Jerry', 'Comedy', 'Tim Story', 'Kayla is responsible for organising a high-profile wedding in a fancy hotel. But when Jerry, a mischievous mouse, wreaks havoc in the hotel, she enlists his arch-rival\'s help to get rid of him.', 101, 'Chloe Grace Moretz', 'Pallavi Sharda', 'William Hanna', 'USA', 'PG', '0000-00-00', 5.2, 'https://www.youtube.com/watch?v=kP9TfCWaQT4', 'TomandJerry2021.png', 0),
('Unforgettable2017', 'Unforgettable', 'Drama', 'Denise Di Novi', 'Julia falls in love with David, a handsome divorcee, and gets engaged to him. However, David\'s former wife, who still loves him, decides to ruin Julia\'s life.', 100, 'Rosario Dawson', 'Katherine Heigl', 'Geoff Stults', 'USA', 'NC-16', '0000-00-00', 5.7, 'https://www.youtube.com/watch?v=iFXIBL617yc', 'Unforgettable2017.png', 0),
('Unsullied2014', 'Unsullied', 'Horror', 'Simeon Rice', 'Held captive in an isolated cabin, a track star (Murray Gray) escapes into the Florida wilderness and fights for survival against the two men (Rusty Joiner, James Gaudioso) who kidnapped her.', 93, 'Rusty Joiner', 'Murray Gray', 'James Gaudioso', 'USA', 'R-21', '0000-00-00', 4.0, 'https://www.youtube.com/watch?v=d5MyZNVD4qk', 'Unsullied2014.png', 0),
('WalkingwithDinosaurs2013', 'Walking with Dinosaurs', 'Family', 'Barry Cook', 'While on a fossil hunt, a palaeontologist\'s nephew encounters an Alexornis bird from the Cretaceous period. The bird narrates the story of dinosaurs which existed at that time.', 87, 'John Leguizamo', 'Justin Long', 'Tiya Sircar', 'United Kingdom', 'PG', '0000-00-00', 5.2, 'https://www.youtube.com/watch?v=P7lBKBxIwGM', 'WalkingwithDinosaurs2013.png', 0),
('WeatheringwithYou2019', 'Weathering with You', 'Fantasy', 'Makoto Shinkai', 'Set during a period of exceptionally rainy weather, high-school boy Hodaka Morishima runs away from his troubled rural home to Tokyo and befriends an orphan girl who can manipulate the weather.', 114, 'Kotaro Daigo', 'Nana Mori', 'Shun Oguri', 'Japan', 'PG', '0000-00-00', 7.5, 'https://www.youtube.com/watch?v=Q6iK6DjV_iE', 'WeatheringwithYou2019.png', 0),
('WeHaveaGhost2023', 'We Have a Ghost', 'Fantasy', 'Christopher Landon', 'The discovery that their house is haunted by a ghost named Ernest makes Kevin\'s family a social media sensation. But when Kevin and Ernest get to the bottom of the mystery of Ernest\'s past, they become targets of the CIA.', 127, 'David Harbour', 'Jahi Winston', 'Anthony Mackie', 'USA', 'PG-13', '0000-00-00', 6.1, 'https://www.youtube.com/watch?v=82I1ErFD63U', 'WeHaveaGhost2023.png', 1),
('WelcomeHomeRoscoeJenkins2008', 'Welcome Home Roscoe Jenkins', 'Family', 'Malcolm D. Lee', 'A successful talk show host visits his Southern family for his parents\' 50th anniversary. But he is not looking forward to revisiting his past where he was nothing more than an awkward little boy.', 118, 'Martin Lawrence', 'Margaret Avery', 'Joy Bryant', 'USA', 'PG-13', '0000-00-00', 5.5, 'https://www.youtube.com/watch?v=wfTyPryL3BQ', 'WelcomeHomeRoscoeJenkins2008.png', 0),
('WithoutMen2011', 'Without Men', 'Comedy', 'Gabriela Tagliavini', 'The women of a remote Latin American town are forced to pick up the pieces and remake their world when all the town\'s men are forcibly recruited by communist guerrillas.', 87, 'Eva Longoria', 'Christian Slater', 'Kate del Castillo', 'USA', 'PG-13', '0000-00-00', 3.3, 'https://www.youtube.com/watch?v=nWoFjSPi6R0', 'WithoutMen2011.png', 0),
('YourName.2016', 'Your Name.', 'Romance', 'Makoto Shinkai', 'Two teenagers share a profound, magical connection upon discovering they are swapping bodies. Things manage to become even more complicated when the boy and girl decide to meet in person.', 112, 'Ryunosuke Kamiki', 'Mone Kamishiraishi', 'Ryo Narita', 'Japan', 'PG', '0000-00-00', 8.4, 'https://www.youtube.com/watch?v=xU47nhruN-Q', 'YourName.2016.png', 0);
...
INSERT INTO `roomplandb` (`roomID`, `rows`, `columns`, `capacity`, `movieID`, `username`, `dateModified`) VALUES
(1, 5, 5, 25, 'Belle2021', 'cflewittg', '2023-05-14'),
(2, 7, 7, 49, 'Bubble2022', 'ndavidowsky2o', '2023-05-14'),
(3, 10, 10, 100, 'DeepSea2023', 'cflewittg', '2023-05-14'),
(4, 8, 5, 40, 'Scream2022', 'ndavidowsky2o', '2023-05-14'),
(5, 0, 0, 0, '', 'cflewittg', '2023-05-14'),
(6, 10, 7, 70, 'WeHaveaGhost2023', 'ndavidowsky2o', '2023-05-14');
...
--
-- Table structure for table `systemadmindb`
--

CREATE TABLE `systemadmindb` (
  `phoneNo` int(8) DEFAULT NULL,
  `username` varchar(15) DEFAULT NULL,
  `hashedPassw` varchar(64) DEFAULT NULL,
  `email` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `systemadmindb`
--

INSERT INTO `systemadmindb` (`phoneNo`, `username`, `hashedPassw`, `email`, `age`) VALUES
